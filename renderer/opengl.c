...
void m_gpu_draw_monochrome_rectangle_variable_size_semi_transparent(uint32_t m_value, m_simplestation_state *m_simplestation)
{
	Rectangle r0;
...
void m_gpu_draw_texture_blend_variable_size_rect(uint32_t m_value, m_simplestation_state *m_simplestation)
{
    Rectangle r0;
